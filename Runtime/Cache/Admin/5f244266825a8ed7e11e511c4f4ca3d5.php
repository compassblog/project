...
<title>管理登录</title>
<link rel="stylesheet" type="text/css" href="<?php echo CS_PATH;?>admin/login.css" />
<!--[if IE 6]>
	...
	<div class="main">
		<div class="login">
			...
			<div class="right">
				...
				<p>
					<label>密&nbsp;&nbsp;&nbsp;码：</label><input type='password' name="password"  class="Inpt" placeholder="请输入密码" datatype="*"/>
				</p>
				<p>
					<label>验证码：</label><input type='text' name="verify" class="captcha" placeholder="验证码" datatype="/\w{3}/i" errormsg="请输入4位验证码！" /><img src="<?php echo U('Public/verify');?>" id="verify" alt="看不清楚，换一张" style="cursor: pointer; vertical-align:middle; margin-top:-4px!important;maargin-top:-0px" onclick="this.src='<?php echo U('Public/verify');?>&_t=' + Math.round(new Date().getTime()/1000)" />
				</p>
				<p>
