                                    ...
                                    <ul class="web">
                                        <li>
                                            <strong>管理组：</strong>
                                                ...
                                                <input type="text" class="text_input"  name="description" placeholder='' datatype="*3-15" value="<?php echo ($info["description"]); ?>" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
                                        ...
                                        <li>
                                            ...
                                            <span class="Validform_checktip" style="margin-left:3px;">设置状态</span>
                                        </li>
                                
     <li>
                                            <strong>权限：</strong>
                                             <b style="width:250px;">
                                             	<?php if(is_array($node)): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><label><input type="checkbox" name="rules[]" placeholder=''  value='<?php echo ($v["id"]); ?>' <?php if(in_array(($v["id"]), is_array($info['rules'])?$info['rules']:explode(',',$info['rules']))): ?>checked='checked'<?php endif; ?>><?php echo ($v["node_name"]); ?></label>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>                                            	
                                            	
                                            </b>
                                            <span class="Validform_checktip" style="margin-left:3px;">设置操作权限</span>
                                        </li>                                                                      
