...
<script type="text/javascript">
	...
	var dataurl = '<?php echo U('Admin/lists')?>';
	...
	$(function(){
		dom.datagrid({
			...
			columns:[[
				{field:'username',title:'管理员名称',fixed:true,align:'center',width:'20%'},
			
				{field:'group_name',title:'管理员组',fixed:true,width:'20%',align:'center'},
