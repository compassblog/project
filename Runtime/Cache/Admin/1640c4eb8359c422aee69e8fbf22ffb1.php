...
<div class="content">
	...
	<div class="goods mt10">
		<div class="guanli">
			<form action="<?php echo U('AdminAuth/lists'); ?>" method='post'>
...
<script type="text/javascript">
	...
	var dataurl = '<?php echo U('AdminAuth/lists')?>';
	...
	$(function(){
		dom.datagrid({
			...
			columns:[[
				{field:'description',title:'管理组',fixed:true,align:'center',width:'20%'},
			
				{field:'status',title:'状态',fixed:true,width:'20%',align:'center'},
				{field:'userID',title:'操作',width:'60%',align:'center',halign:'center',
