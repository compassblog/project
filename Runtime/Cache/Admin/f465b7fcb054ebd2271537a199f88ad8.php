                                    ...
                                    <ul class="web">
                                        <li>
                                            <strong>节点名称：</strong>
                                                ...
                                                <input type="text" class="text_input"  name="node_name" placeholder='' datatype="*3-15" value="<?php echo ($info["node_name"]); ?>" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
                                         ...
                                         <li>
                                            <strong>选择节点：</strong>
                                            <select name="pid" style="margin-right: 44px;" datatype="n1-20" ignore="ignore">
                                            	<?php if($info == null): ?><option value=''>请选择</option>
                                                <option value="0">根节点</option>
                                                <?php if(is_array($node)): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["node_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>	
                                                <?php else: ?>
                                                	<?php if($info['pid'] == 0): ?><option value="0">根节点</option>
                                                	<?php else: ?>
                                                	    <option value="<?php echo ($node["id"]); ?>"><?php echo ($node["node_name"]); ?></option><?php endif; ?>
                                               <!--<?php if(is_array($node)): $i = 0; $__LIST__ = $node;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $info['pid']): ?>selected<?php endif; ?>><?php echo ($vo["node_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>	--><?php endif; ?>
                                            </select>
                                        ...
                                        <li>
                                            <strong>默认控制器名：</strong>
                                         
                                                <input type="text" class="text_input"  name="controller" placeholder='' datatype="*3-15" value="<?php echo ($info["controller"]); ?>" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
                                        ...
                                        <li>
                                            <strong>默认方法名：</strong>
                                                ...
                                                <input type="text" class="text_input"  name="action" placeholder='' datatype="*3-15" value="<?php echo ($info["action"]); ?>" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
