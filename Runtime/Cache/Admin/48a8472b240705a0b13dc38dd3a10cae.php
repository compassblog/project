                                    ...
                                    <ul class="web">
                                        <li>
                                            <strong>旧密码：</strong>
                                                ...
                                                <input type="text" class="text_input"  name="oldpwd" placeholder='' datatype="*3-15" value="" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
                                        ...
                                        <li>
                                            <strong>新密码：</strong>
                                                ...
                                                <input type="text" class="text_input"  name="pwd" placeholder='' datatype="*3-15" value="" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
                                        ...
                                        <li>
                                            <strong>重复新密码：</strong>
                                                ...
                                                <input type="text" class="text_input"  name="pwd2" placeholder='' datatype="*3-15" value="" /><span class="Validform_checktip ">设置管理组名称，3-15个字符，英文，数字或中文皆可</span>
